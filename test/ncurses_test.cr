...
Ncurses.mvaddstr(39, 0, "Test of attrset and mvaddstr.  которая. This text should be yellow.")
w.attrset(Ncurses::A_BLINK)
#w.mvaddstr(40, 0, "Test of attrset and mvaddstr.  которая. This text should be blinking.")
LibNCurses.mvwaddstr(w, 40, 0, "Test of attrset and mvaddstr.  которая. This text should be blinking.")
