...
---------------------------------
  ...
  Enter : Expand/collapse or activate item
    ...
    C-n : Jump to next message and open
      p : Jump to previous open message
    C-p : Jump to previous message and open
     ...
     ,a : Archive this thread and view next
     ,d : Delete this thread, kill buffer, and view next
...
---------------------------------
     ...
     Down, j : Move cursor down one line
       ...
       click : Click on item
 doubleclick : Double-click on item
...
----------------------------
 ...
 PgDn, Space, C-f : Down one page
   PgUp, C-h, C-b : Up one page
              C-d : Down one half page
              C-u : Up one half page
       Home, ^, 1 : Jump to top
